...
public class StudentInfoApplication {
    ...
    public static void main(String[] args) {
        ...
        app.creatSubject(); //과목개설, 과목 학교에 등록
        app.createStudent();
    ...
    public void createStudent(){
        ...
        Student student3 = new Student(171230, "도라에몽", korean);
        Student student4 = new Student(171255, "팜하니", korean);
        Student student5 = new Student(171590, "이영광", math);
